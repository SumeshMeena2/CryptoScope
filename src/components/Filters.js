...
const Filters = () => {
  ...
  return (
    ...
    <div className=' w-full border border-cyan flex justify-between items-center p-2 gap-2  max-lg:gap-[0.5rem] max-ssm:flex-col '  >
        
        <Search/>
        <div className=' flex mr-7 max-md:mr-3 '>
        ...
        <label className='relative flex justify-center items-center max-md:w-40 '>
